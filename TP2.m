...
%% Maintenant avec tous les sujets

%matrice de stockage des moyennes des électrodes O selon les sujets en ligne
%et les conditions en colonne.

moyennes_O1 = zeros(20,2);
moyennes_Oz = zeros(20,2);
moyennes_O2 = zeros(20,2);
...
moyennes_O1(k,1) = mean(somme_O1_cond1);
moyennes_Oz(k,1) = mean(somme_Oz_cond1);
moyennes_O2(k,1) = mean(somme_O2_cond1);
...
moyennes_O1(k,2) = mean(somme_O1_cond2);
moyennes_Oz(k,2) = mean(somme_Oz_cond2);
moyennes_O2(k,2) = mean(somme_O2_cond2);
